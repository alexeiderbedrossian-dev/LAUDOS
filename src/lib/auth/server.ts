...
const publicDeployHosts: string[] = ["*.vercel.app"];
...
const trustedOrigins: string[] = explicitBaseURL
  ...
  : [
      ...
      ...publicDeployHosts.flatMap((host) => [`https://${host}`, `http://${host}`]),
      ...LOCAL_DEV_ORIGINS,
    ];
...
export const auth = betterAuth({
  ...
  secret: env("BETTER_AUTH_SECRET") ?? (env("VERCEL") ? "merces-laudos-auth-2026-9f3c2a7b" : previewAuthSecret()),
  database,
